...
macro(add_llvm_library name)
  ...
  llvm_process_sources( ALL_FILES ${XXXARG_DEFAULT_ARGS} )
  add_library(obj.${name} OBJECT ${ALL_FILES})
  if (XXXARG_DEPENDS)
    add_dependencies(obj.${name} ${XXXARG_DEPENDS})
  endif ()
  add_library(${name} $<TARGET_OBJECTS:obj.${name}>)
...
macro(add_llvm_executable name)
  ...
  if( EXCLUDE_FROM_ALL )
    add_executable(${name} EXCLUDE_FROM_ALL $<TARGET_OBJECTS:obj.${name}>)
  else()
    add_executable(${name} $<TARGET_OBJECTS:obj.${name}>)
  endif()
...
function(add_unittest test_suite test_name)
  ...
  if (MSVC AND MSVC_VERSION EQUAL 1700)
    set_property(TARGET obj.${test_name} APPEND PROPERTY COMPILE_DEFINITIONS _VARIADIC_MAX=10)
  endif ()

  include_directories(${LLVM_MAIN_SRC_DIR}/utils/unittest/googletest/include)
  set_property(TARGET obj.${test_name} APPEND PROPERTY COMPILE_DEFINITIONS GTEST_HAS_RTTI=0)
  if (NOT LLVM_ENABLE_THREADS)
    set_property(TARGET obj.${test_name} APPEND PROPERTY COMPILE_DEFINITIONS GTEST_HAS_PTHREAD=0)
  endif ()

  get_property(target_compile_flags TARGET obj.${test_name} PROPERTY COMPILE_FLAGS)
  ...
  set_property(TARGET obj.${test_name} PROPERTY COMPILE_FLAGS "${target_compile_flags}")
endfunction()
