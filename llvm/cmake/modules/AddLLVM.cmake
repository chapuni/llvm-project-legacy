...
function(set_output_directory target propname prefix suffix)
  if (NOT "${CMAKE_CFG_INTDIR}" STREQUAL ".")
    foreach (build_mode ${CMAKE_CONFIGURATION_TYPES})
      string(TOUPPER "${build_mode}" CONFIG_SUFFIX)
      set("${varname}_${CONFIG_SUFFIX}" "${CMAKE_BINARY_DIR}/${build_mode}/${dir}" PARENT_SCOPE)
      set_target_properties(${target}
        PROPERTIES "${propname}_${CONFIG_SUFFIX}" "${prefix}/${build_mode}/${suffix}")
    endforeach ()
  else()
    set_target_properties(${target}
      PROPERTIES ${propname} "${prefix}/${suffix}")
  endif ()
#set_target_properties(${name} PROPERTIES RUNTIME_OUTPUT_DIRECTORY_RELWITHDEBINFO "${CMAKE_BINARY_DIR}/RelWithDebInfo/xxxbin")
endfunction()

macro(add_llvm_library name)
  llvm_process_sources( ALL_FILES ${ARGN} )
  add_library( ${name} ${ALL_FILES} )
  set_output_directory(${name} ARCHIVE_OUTPUT_DIRECTORY ${CMAKE_BINARY_DIR} lib)
  set_output_directory(${name} RUNTIME_OUTPUT_DIRECTORY ${CMAKE_BINARY_DIR} bin)
  set_output_directory(${name} LIBRARY_OUTPUT_DIRECTORY ${CMAKE_BINARY_DIR} lib)
...
function(add_unittest test_suite test_name)
  ...
  set_output_directory(${test_name} ARCHIVE_OUTPUT_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR} .)
  set_output_directory(${test_name} LIBRARY_OUTPUT_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR} .)
  set_output_directory(${test_name} RUNTIME_OUTPUT_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR} .)
...
function(configure_lit_site_cfg input output)
  ...
  set(LLVM_TOOLS_DIR "${LLVM_BINARY_DIR}/${LLVM_BUILD_MODE}/bin")
  set(LLVM_LIBS_DIR "${LLVM_BINARY_DIR}/${LLVM_BUILD_MODE}/lib")
